...
%         'memory' 'stimSet' 'listNum' 'versionRewardCat'
     ...
     blockLength=30;
     aq = ReversalTask_Aquisition(p.versionRewardCat,p.day,p.med,p.scanned,folder_name, p.SubjectNumber,p.list, prob,blockLength,nTrials,trigger,buttonBox,kb);
