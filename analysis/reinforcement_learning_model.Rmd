...
standata = list(NS=NS, NC=2,K=2, MT=MT, NT= NT, choice=choice, cat_choice=cat_two_choice, rew=rew )
standard_fit <- stan(file = '~/GitHub/reversal_learning_pd/rl.stan', data = standard_standata, iter = 1250, warmup = 250, chains = 4)
